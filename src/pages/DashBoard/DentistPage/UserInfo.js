...
const UserInfo = () => {
  ...
  const renderBusinessServices = () => {
    ...
    return (
      <>
        {userData.businessServices.map((service) => (
          <div key={service.id} className="col-span-6 sm:col-span-3 mb-4">
            <label htmlFor={`service-name-${service.id}`} className="text-sm font-semibold text-gray-900 block mb-2">
              Business Service
            </label>
            <input
              type="text"
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between mb-4">
          <div>
            ...
            <Switch checked={userData.emailConfirmed} disabled />
          </div>
          <div>
            <label htmlFor="phone-confirmed" className="font-semibold mr-2">
              Phone Confirmed:
            </label>
            <Switch checked={userData.phoneConfirmed} disabled />
          </div>
        </div>
        <div className="mb-4">
